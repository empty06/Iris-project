...
# Criar o dataset (número de exemplos, tamanho da sequência, número de caracteres) one-hot
# Criar daraset disperso (número de exemplos, tamanho da sequência)

# Input dara one-hot encoding
